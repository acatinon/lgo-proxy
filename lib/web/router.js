...
function mapDeprecatedRoutes(routing, exchangeProxy) {
...
function mapLiveRoutes(routing, exchangeProxy) {
...
function createRouter(dependencies) {
  ...
  mapDeprecatedRoutes(routing, exchangeProxy);
  mapLiveRoutes(routing, exchangeProxy);
